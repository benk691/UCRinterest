...
from ucri.UCRinterest.config import ALLOWED_EXTENSIONS, UPLOAD_FOLDER, DEFAULT_PROFILE_PIC, DEFAULT_PROFILE_PIC_PATH, DEFAULT_PROFILE_PIC_LOC
...
from ucri.UCRinterest.ucri.users.profile import handleUserDeletion
